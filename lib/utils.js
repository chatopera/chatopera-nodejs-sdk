...
exports.DEFAULT_CACHED_WORKSDIR = "workspace";
exports.CHATOPERA_JSON_FNAME = "chatopera.json"
exports.CONVERSATION_NAME_PATTERN = /^[a-zA-Z0-9]*$/;
 ...
 */
exports.removeFilenameExtension = (filename, ext) => {
  if (!ext.startsWith(".")) {
    ext = "." + ext;
  }
  if (filename.endsWith(ext)) {
    let extr = _.reverse(ext.split("")).join("");
    let fr = (_.reverse(filename.split("")).join("")).substring(ext.length);
    return _.reverse(fr.split("")).join("");
  }
